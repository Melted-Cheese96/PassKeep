...
class PassKeep:
    ...
    def options(self):  # Main Window
        ...
        read_password_button = tk.Button(self.options_window, text='Retrieve account details ', command=self.read_password_gui)
    ...
    def read_password(self): # responsible for reading saved accounts
        ...
        try:
            ...
            if 'username' in all_files:
                ...
                messagebox.showinfo('Result', 'Your username is {}, your password is {}'.format(decrypted_username, decrypted_password))
            else:
                decrypted_password = f.decrypt(encrypted_password)
                decrypted_password = decrypted_password.decode()
